...
output_files = glob("../output/semi-synth/*.csv")
...
for output_file in output_files:
    ...
    drifted_df = df.iloc[np.r_[(75000/500):(100000/500)]]
...
accuracy.to_csv("./semi-synth/summarized_acc.csv", )
kappa.to_csv("./semi-synth/summarized_kappa.csv", )
gmean.to_csv("./semi-synth/summarized_gmean.csv", )
gmean_affected.to_csv("./semi-synth/summarized_gmean_affected.csv", )
mem_usage_df.to_csv("./semi-synth/summarized_mem_usage.csv")
cpu_time_df.to_csv("./semi-synth/summarized_cpu_time.csv")
...
accuracy_drifted.to_csv("./semi-synth/summarized_drifted_acc.csv", )
gmean_drifted.to_csv("./semi-synth/summarized_drifted_gmean.csv", )
kappa_drifted.to_csv("./semi-synth/summarized_drifted_kappa.csv", )
gmean_affected_drifted.to_csv("./semi-synth/summarized_drifted_gmean_affected.csv", )